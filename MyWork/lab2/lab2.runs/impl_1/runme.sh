...
HD_PWD='D:/NUS/ee2026/MyWork/lab2/lab2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fourBitSubtractor.vdi -applog -m64 -messageDb vivado.pb -mode batch -source fourBitSubtractor.tcl -notrace
