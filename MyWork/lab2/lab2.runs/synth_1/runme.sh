...
HD_PWD='D:/NUS/ee2026/MyWork/lab2/lab2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fourBitSubtractor.vds -m64 -mode batch -messageDb vivado.pb -notrace -source fourBitSubtractor.tcl
